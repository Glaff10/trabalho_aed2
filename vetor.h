...
void criarListaEncadeada(ListaEncadeada *lista); // Cria Lista encadeada
No* CriaNo(int num); //Cria um novo no
void CriaNoListaEncadeada(ListaEncadeada *lista, int num); //Cria um novo no na lista
